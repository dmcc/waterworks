"""
URL: http://aspn.activestate.com/ASPN/Cookbook/Python/Recipe/52215
Title: Get more information from tracebacks
Submitter: Bryn Keller (other recipes)
...
functions to produce useful information about where and why an error
occurred. Traceback objects actually contain a great deal more information
than the traceback module displays, however. That information can greatly
assist in detecting the cause of your error.

Here's an example of an extended traceback printer you might use,
